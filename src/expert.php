...
echo substr($str, 0, 10); //substr function return part of the string
...
foreach($week as &$day) { // (&) symbol refer to $week reference to $day
...
function isLinkValid(string $link) {
    ...
    foreach ($unacceptables as $unacceptable) {
        if (strpos($link, $unacceptable) !== false) { // (!== false) & (> -1)
...
//
//}
$filtered = array_filter($areTheseFruits, function ($value){
    global $validFruits;
